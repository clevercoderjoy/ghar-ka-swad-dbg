  ...
  return (
    ...
    >
      <img
        ...
        decoding="async"
      />
      <div className="absolute inset-0 z-0 bg-black/35 backdrop-blur-[2px]" />
      <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/25 to-black/50 pointer-events-none z-0" />

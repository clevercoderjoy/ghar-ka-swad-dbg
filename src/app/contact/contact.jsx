...
function ContactCard({ info }) {
  ...
  const cardInner = (
    <div
      ref={cardRef}
      tabIndex={0}
      className="group relative h-full p-6 rounded-3xl bg-black/35 backdrop-blur-md border border-white/20 hover:border-primary/40 shadow-[0_4px_30px_rgba(252,128,25,0.06),inset_0_1px_1px_rgba(252,128,25,0.08)] hover:shadow-2xl transition-all duration-200 overflow-hidden focus:outline-none contact-card"
...
function LiquidGlassCTA() {
  ...
  return (
    <div
      ...
      className="group relative rounded-3xl bg-black/35 backdrop-blur-md border border-white/20 hover:border-primary/40 shadow-xl hover:shadow-2xl transition-all duration-200 overflow-hidden focus:outline-none contact-card"
